      ...
      <div className="container">
        ...
        <ul>
          ...
          <li>
            ...
            this Agreement) refers to Axzel Advisory (Pty) Ltd, 165 Hendrik
            Street, Wierda Park, Centurion, 0157.
          </li>
          <li>
          ...
          <li>
            Website refers to Axzel Advisory Services, accessible from
            http://www.axzel.co.za
          </li>
          <li>
        ...
        <p>
          ...
          browser. Learn more about cookies: Cookies: What Do They Do?.
        </p>
        <p>
        ...
        <ul>
          <li>By email: info@axzel.co.za</li>
          <li>By visiting this page on our website: http://www.axzel.co.za</li>
        </ul>
      </div>
    </Wrapper>
  );
